...
/*   Updated: 2024/05/31 03:42:52 by mpierrot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	end_threads(t_data *data, pthread_t *threads)
{
	int	i;

	i = 0;
	data->phil[0].forks->right_fork = \
		&data->phil[data->philo_nb - 1].forks->left_fork;
